...
class DrawingClassifier:
    def __init__(self):
        ...
        #name of directory we're storing the item in
    ...
    def initGUI(self):
        ...
        #this is where we create GUI for the system
        ...
        #binding the motion of cliking a button with a function
        ...
        #functionality buttons below
        #button to decrease ur brush size
        ...
        self.statusLabel = Label(buttonFrame, text=f"Current model is: {type(self.classifier).__name__}")
    ...
    def clear(self):
        ...
        #not just the canvas eeds to be clear, whatever we drew using 
        # PIL should be clear accordingly
        self.draw.rectangle([0,0,500,500], fill="white")
        
        
    def trainModel(self):
        imageList = np.array([])
        classList = np.asarray([])
    ...
    def loadModel(self):
        ...
        tkinter.messagebox.showinfo("Drawing Classifier", f"Model successfully laoded!", parent = self.root)
    ...
    def predictClass(self):
        ...
        if prediction[0] == 1:
            ...
            tkinter.messagebox.showinfo("Drawing Classifier", f"This is probably a(n) {self.class3Counter}", parent = self.root)
